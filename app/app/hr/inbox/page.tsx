...
export default function HrInboxPage() {
  ...
  const [items, setItems] = useState<InboxActionItem[] | InboxLifecycleItem[] | InboxGovernanceItem[] | InboxContractItem[] | InboxMedicalItem[] | InboxTrainingItem[] | InboxCertificateItem[]>([]);
