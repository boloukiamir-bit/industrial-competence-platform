    ...
    <section className={cn("mt-4", className)} aria-label="Compliance control panel">
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          {showLegalAlert && (
            <span className="rounded-md border border-red-500/60 bg-red-500/10 px-2.5 py-1 text-[11px] font-semibold uppercase text-red-300">
              Illegal to operate
            </span>
          )}
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          >
            <p className="text-[11px] uppercase tracking-wider text-slate-400">Legal stoppers</p>
            <p
              className={cn(
          ...
          <div className="rounded-xl border border-amber-500/40 bg-amber-500/5 px-3 py-2">
            <p className="text-[11px] uppercase tracking-wider text-amber-200">Commercial risk</p>
            <p className="mt-1 text-2xl font-semibold tabular-nums">
              {ready ? formatCount(missingNonblocking) : "--"}
            </p>
          </div>

          <div className="rounded-xl border border-slate-800 bg-slate-900/40 px-3 py-2">
            <p className="text-[11px] uppercase tracking-wider text-slate-400">Expiring</p>
            <p className="mt-1 text-2xl font-semibold tabular-nums">
