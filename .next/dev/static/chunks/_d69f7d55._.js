...
async function getEmployeeCompetenceProfile(employeeId, effectiveDate) {
    // Use provided date or default to today
    const effectiveDateStr = effectiveDate ?? new Date().toISOString().slice(0, 10);
    // 1) Employee
...
async function getPositionCoverageForDate(effectiveDate) {
    let positions = [];
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('positions').select('id, name, site, department, min_headcount').gt('min_headcount', 0);
    if (result.error) {
    ...
    for (const pos of positions){
        ...
        for (const emp of employees){
            const profile = await getEmployeeCompetenceProfile(emp.id, effectiveDate);
...
;
;
const DEMO_MODE = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_DEMO_MODE === 'true';
...
function generateDemoData() {
    const columns = DEMO_COMPETENCES.map((c)=>({
            competenceId: c.id,
            label: c.label,
            groupName: c.groupName,
            requiredLevel: c.requiredLevel
        }));
    const rows = DEMO_EMPLOYEES.map((emp)=>{
...
function CompetenceMatrixPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CompetenceMatrixContent, {}, void 0, false, {
        fileName: "[project]/app/competence/matrix/page.tsx",
        lineNumber: 113,
        columnNumber: 10
    }, this);
}
_s(CompetenceMatrixPage, "5Kham9Y53rdVm8Ud2RKznw61LJE=", false, function() {
    return [
...
function CompetenceMatrixContent() {
    ...
    const isDemoMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CompetenceMatrixContent.useMemo[isDemoMode]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CompetenceMatrixContent.useEffect": ()=>{
            if (isDemoMode) {
            ...
            async function loadMatrix() {
                ...
                try {
                    ...
                    const profiles = await Promise.all(employees.map({
                        "CompetenceMatrixContent.useEffect.loadMatrix": (emp)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$competence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEmployeeCompetenceProfile"])(emp.id)
                    }["CompetenceMatrixContent.useEffect.loadMatrix"]));
                    const firstProfile = profiles[0];
                    const mandatoryItems = firstProfile.items.filter({
                        "CompetenceMatrixContent.useEffect.loadMatrix.mandatoryItems": (item)=>item.mandatory
                    }["CompetenceMatrixContent.useEffect.loadMatrix.mandatoryItems"]);
                    const cols = mandatoryItems.map({
                        "CompetenceMatrixContent.useEffect.loadMatrix.cols": (item)=>({
                                competenceId: item.competenceId,
                                label: item.competenceName,
                                groupName: item.groupName,
                                requiredLevel: item.requiredLevel
                            })
                    }["CompetenceMatrixContent.useEffect.loadMatrix.cols"]);
                    const matrixRows = profiles.map({
                        "CompetenceMatrixContent.useEffect.loadMatrix.matrixRows": (profile)=>{
                            const itemMap = new Map(profile.items.map({
                                "CompetenceMatrixContent.useEffect.loadMatrix.matrixRows": (item)=>[
                                        item.competenceId,
                                        item
                                    ]
                            }["CompetenceMatrixContent.useEffect.loadMatrix.matrixRows"]));
                            return {
                                employeeId: profile.employee.id,
                                employeeName: profile.employee.name,
                                riskLevel: profile.summary.riskLevel,
                                items: cols.map({
                                    "CompetenceMatrixContent.useEffect.loadMatrix.matrixRows": (col)=>{
    ...
    const kpis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CompetenceMatrixContent.useMemo[kpis]": ()=>{
            if (rows.length === 0) return null;
            const atRisk = rows.filter({
                "CompetenceMatrixContent.useMemo[kpis]": (r)=>r.riskLevel === 'HIGH'
            }["CompetenceMatrixContent.useMemo[kpis]"]).length;
            const gapSkills = new Map();
            let totalOk = 0;
            let totalCells = 0;
            rows.forEach({
                "CompetenceMatrixContent.useMemo[kpis]": (row)=>{
                    row.items.forEach({
                        "CompetenceMatrixContent.useMemo[kpis]": (item, idx)=>{
                            totalCells++;
            ...
            const topGap = Array.from(gapSkills.entries()).sort({
                "CompetenceMatrixContent.useMemo[kpis]": (a, b)=>b[1] - a[1]
            }["CompetenceMatrixContent.useMemo[kpis]"])[0];
    ...
    const handleExportCSV = ()=>{
        ...
        const csvRows = rows.map((row)=>{
            const cells = row.items.map((item)=>item.level !== null ? `${item.level}/${item.requiredLevel}` : '-');
            return [
                row.employeeName,
                row.riskLevel,
                ...cells
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: [
                error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-3 mb-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 text-sm",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-4 mb-6 rounded-lg border border-border bg-card",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            selectedPosition && !loadingMatrix && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            rows.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                kpis && selectedPositionId && !loadingMatrix && rows.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `text-2xl font-semibold ${kpis.atRisk > 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}`,
                                    children: kpis.atRisk
                                }, void 0, false, {
                                    fileName: "[project]/app/competence/matrix/page.tsx",
                                    lineNumber: 361,
                                    columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    title: kpis.topGapSkill,
                                    children: kpis.topGapSkill
                                }, void 0, false, {
                                    fileName: "[project]/app/competence/matrix/page.tsx",
                                    lineNumber: 370,
                                    columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `text-2xl font-semibold ${kpis.avgReadiness >= 80 ? 'text-green-600 dark:text-green-400' : kpis.avgReadiness >= 60 ? 'text-amber-600 dark:text-amber-400' : 'text-red-600 dark:text-red-400'}`,
                                    children: [
                                        kpis.avgReadiness,
                                        "%"
                                    ]
                ...
                !selectedPositionId && !loadingPositions && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-6 rounded-lg border border-dashed border-border bg-muted/50 text-center",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground",
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tooltip"], {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipTrigger"], {
                                                            asChild: true,
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "hr-competence-name cursor-help",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "max-w-[100px] overflow-hidden text-ellipsis whitespace-nowrap block",
                                                                        children: col.label.length > 12 ? col.label.slice(0, 12) + '...' : col.label
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/competence/matrix/page.tsx",
                                                                        lineNumber: 420,
                                                                        columnNumber: 29
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipContent"], {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    col.groupName && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "text-muted-foreground",
                                                                        children: [
                                                                            " (",
                                                                            col.groupName,
                                        ...
                                        children: [
                                            ...
                                            row.items.map((cell, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "hr-matrix-cell__levels",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        children: cell.requiredLevel ?? columns[idx]?.requiredLevel ?? '-'
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/competence/matrix/page.tsx",
                                                                        lineNumber: 458,
                                                                        columnNumber: 29
...
_s1(CompetenceMatrixContent, "jZQkgIesbzJBV/xEk2Cj+4ZWOOw=");
_c1 = CompetenceMatrixContent;
var _c, _c1;
__turbopack_context__.k.register(_c, "CompetenceMatrixPage");
__turbopack_context__.k.register(_c1, "CompetenceMatrixContent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_d69f7d55._.js.map