...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmail"])(email, password);
            router.replace('/app/hr/tasks');
        } catch (error) {
            console.error(error);
...
_s(LoginPage, "fqVfalSs6bb+7pVQL1Md7gAL27w=", false, function() {
    return [
...
//# sourceMappingURL=_e9d1c282._.js.map