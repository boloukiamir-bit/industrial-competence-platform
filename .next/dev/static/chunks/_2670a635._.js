...
"[project]/app/app/safety/certificates/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SafetyCertificatesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SafetyCertificatesPage.useEffect": ()=>{
            async function load() {
                const [certsRes, linesRes, skillsRes] = await Promise.all([
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("employee_skills").select(`
            employee_id,
            skill_id,
            level,
          ...
          `).in("skills.category", [
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("employees").select("line").eq("is_active", true),
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("skills").select("id, name").in("category", [
                        "safety",
                        "certificate"
                    ])
                ]);
                const employeeIds = [
                    ...new Set((certsRes.data || []).map({
                        "SafetyCertificatesPage.useEffect.load": (s)=>{
                            const emp = s.employees;
                            return emp?.id;
                        }
                    }["SafetyCertificatesPage.useEffect.load"]).filter(Boolean))
                ];
                let trainingEvents = [];
                if (employeeIds.length > 0) {
                    const { data: eventsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("person_events").select("employee_id, category, completed_date, due_date").eq("category", "training").in("employee_id", employeeIds);
                ...
                const mappedCerts = (certsRes.data || []).filter({
                    "SafetyCertificatesPage.useEffect.load.mappedCerts": (row)=>{
                        const emp = row.employees;
                        return emp?.is_active === true;
                    }
                }["SafetyCertificatesPage.useEffect.load.mappedCerts"]).map({
                    "SafetyCertificatesPage.useEffect.load.mappedCerts": (row)=>{
                        const emp = row.employees;
                ...
                }["SafetyCertificatesPage.useEffect.load.mappedCerts"]);
                setCertificates(mappedCerts);
                setLines([
                    ...new Set((linesRes.data || []).map({
                        "SafetyCertificatesPage.useEffect.load": (r)=>r.line
                    }["SafetyCertificatesPage.useEffect.load"]).filter(Boolean))
                ].sort());
                setSkills((skillsRes.data || []).map({
                    "SafetyCertificatesPage.useEffect.load": (s)=>({
                            id: s.id,
                            name: s.name
                        })
                }["SafetyCertificatesPage.useEffect.load"]));
                setLoading(false);
            }
            load();
        }
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            skills.map((skill)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: skill.id,
                                    children: skill.name
                                }, skill.id, false, {
                                    fileName: "[project]/app/app/safety/certificates/page.tsx",
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            ...
                            children: filteredCerts.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-4 py-3",
                                            children: dueStatus ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SafetyCertificatesPage, "UY8oUyv8RHJuiSCCrDhS704tsFU=");
_c = SafetyCertificatesPage;
var _c;
__turbopack_context__.k.register(_c, "SafetyCertificatesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_2670a635._.js.map