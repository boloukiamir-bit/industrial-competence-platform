...
function DocumentsPage() {
    ...
    const fetchDocuments = async ()=>{
        setLoading(true);
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("documents").select("*").is("employee_id", null).order("created_at", {
            ascending: false
        });
    ...
    const handleAddDocument = async ()=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("documents").insert({
            title: newDoc.title,
            type: newDoc.type,
            url: newDoc.url,
            employee_id: null
...
_s(DocumentsPage, "C9kAyGwYV+k5BRSpXNPUtwhGAV0=");
_c = DocumentsPage;
var _c;
...
//# sourceMappingURL=_49cdcd4b._.js.map