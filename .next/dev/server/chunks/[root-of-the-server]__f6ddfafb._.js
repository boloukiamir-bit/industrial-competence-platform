...
function getServerSupabase() {
    ...
    const url = ("TURBOPACK compile-time value", "https://bmvawfrnlpdvcmffqrzc.supabase.co");
    const key = process.env.SUPABASE_SERVICE_ROLE_KEY;
    if (!url || !key) {
        throw new Error("Supabase server config missing");
    }
    serverClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$esm$2f$wrapper$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createClient"])(url, key, {
        auth: {
...
async function GET(request) {
    try {
        ...
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSupabase"])();
        const { data: templates, error } = await supabase.from("wf_templates").select(`
        id,
        name,
        description,
        category,
      ...
      `).eq("org_id", orgId).eq("is_active", true).order("name");
        ...
        const templatesWithCount = (templates || []).map((t)=>({
                ...
                steps: t.wf_template_steps?.sort((a, b)=>a.step_no - b.step_no) || []
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6ddfafb._.js.map