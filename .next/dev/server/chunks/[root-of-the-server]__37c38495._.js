...
"[project]/app/api/spaljisten/setup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!email || email.toLowerCase() !== "daniel.buhre@spaljisten.se") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Invalid setup request: Only daniel.buhre@spaljisten.se can be set up"
            }, {
                status: 400
            });
        }
        ...
        try {
            ...
            if (!setupResult?.success) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: setupResult?.error || "Setup failed"
                }, {
                    status: 400
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__37c38495._.js.map